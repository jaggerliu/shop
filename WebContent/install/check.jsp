		...
		<div class="bodyRight">
			<table>
				...
				<tr>
					...
					<td>Tomcat</td>
					<td>Tomcat 6.0</td>
					<td><span title="<%=application.getServerInfo()%>"> <%=StringUtils.substring(application.getServerInfo(), 0, 25)%>
					</span></td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>字符集编码:</strong></td>
					<td>UTF-8</td>
					<td>UTF-8</td>
					<td><span id="encodingInfo"></span></td>
				</tr>
			</table>
			<table>
				<tr>
					<th width="344">文件目录</th>
					<th width="170">所需状态</th>
					<th>当前状态</th>
				</tr>
				<tr>
					<td>/WEB-INF/classes/shopxx.xml</td>
					<td>可写</td>
					<td><%=isShopxxXmlCanWriteInfo%></td>
				</tr>
				<tr>
					<td>/WEB-INF/classes/shopxx.properties</td>
					<td>可写</td>
					<td><%=isShopxxPropertiesInfo%></td>
				</tr>
				<tr>
					<td>/WEB-INF/web.xml</td>
					<td>可写</td>
					<td><%=isWebXmlCanWriteInfo%></td>
				</tr>
				<tr>
					<td>/upload/</td>
					<td>可写</td>
					<td><%=isUploadCanWriteInfo%></td>
				</tr>
			</table>
		</div>
