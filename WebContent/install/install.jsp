	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td><strong class="message"><%=message%></strong></td>
				</tr>
			</table>
			<table>
				<tr>
		...
		<div class="buttonArea">
			<input type="button" id="previous" class="button" value="上 一 步"
				onclick="location.href='setting.jsp'" />&nbsp;&nbsp;&nbsp;&nbsp; <input
				type="button" id="complete" class="button" value="完成安装"
				disabled="disabled" />
		</div>
	</div>
	<div class="footer">
