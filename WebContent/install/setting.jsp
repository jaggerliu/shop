...
<body>
			...
			<div class="bodyRight">
				<table>
					...
					<tr>
						...
						<td><select id="databaseType" name="databaseType">
								<option value="">请选择...</option>
								<option value="mysql">MySQL</option>
								<option value="sqlserver">SQL Server</option>
								<option value="oracle">Oracle</option>
						</select> <span class="requireField">*</span></td>
					</tr>
					<tr>
						<td>数据库主机:</td>
						<td><input type="text" id="databaseHost" name="databaseHost"
							class="text" value="localhost" maxlength="200" /> <span
							class="requireField">*</span></td>
					</tr>
					<tr>
						<td>数据库端口:</td>
						<td><input type="text" id="databasePort" name="databasePort"
							class="text" value="3306" maxlength="200" /> <span
							class="requireField">*</span></td>
					</tr>
					<tr>
						<td>数据库用户名:</td>
						<td><input type="text" id="databaseUsername"
							name="databaseUsername" class="text" maxlength="200" /> <span
							class="requireField">*</span></td>
					</tr>
					<tr>
						<td>数据库密码:</td>
						<td><input type="password" id="databasePassword"
							name="databasePassword" class="text" maxlength="200" /></td>
					</tr>
					<tr>
						<td>数据库名称:</td>
						<td><input type="text" id="databaseName" name="databaseName"
							class="text" value="shopxx" maxlength="200" /> <span
							class="requireField">*</span></td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td width="120">用户名:</td>
						<td><input type="text" id="adminUsername"
							name="adminUsername" class="text" value="admin" maxlength="20" />
							<span class="requireField">*</span></td>
					</tr>
					<tr>
						<td>密码:</td>
						<td><input type="password" id="adminPassword"
							name="adminPassword" class="text" maxlength="20" /> <span
							class="requireField">*</span></td>
					</tr>
					<tr>
						<td>重复密码:</td>
						<td><input type="password" id="reAdminPassword"
							name="reAdminPassword" class="text" maxlength="20" /> <span
							class="requireField">*</span></td>
					</tr>
				</table>
				<table>
					...
					<tr>
						...
						<td><input type="checkbox" id="isCreateDatabase"
							name="isCreateDatabase" value="true" checked="checked" /></td>
					</tr>
					<tr>
						<td>初始化DEMO数据:</td>
						<td><input type="checkbox" id="isInitializeDemo"
							name="isInitializeDemo" value="true" checked="checked" /></td>
					</tr>
				</table>
			</div>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2013 shopxx.net All Rights
			Reserved.</p>
	</div>
</body>
</html>